public class Program
{
    ...
    {
        // Voeg jezelf als een nieuwe persoon toe

        // Toon info van de persoon die je net hebt toegevoegd door de ToString methode te gebruiken

        // Voeg een nieuwe auto toe met als eigenaar de persoon die je net hebt toegevoegd

        // Toon info van de auto die je net hebt toegevoegd door de Info methode te gebruiken
